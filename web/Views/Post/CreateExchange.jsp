            ...
            <div class="p-4" style="margin-bottom: 42px;">
                ...
                <form action="createExchange" method="post" enctype="multipart/form-data">
                    <div class="row m-5 rounded-3" style="background-color: papayawhip">
                        ...
                        <div class="mb-3">
                            <input type="checkbox" id="freeGiftCheckbox" onchange="updateInputRequired()"> Trao tặng miễn phí
                        </div>
                        <div class="mb-3" id="priceInput">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="exchangePrice" type="number" step="any" name="price" class="form-control" aria-label="Amount (to the nearest dollar)" required min="0">
                            </div>
                        </div>
                        <div class="mb-3">
