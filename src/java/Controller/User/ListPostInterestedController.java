 ...
 * @author dell
 */
public class ListPostInterestedController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getSession().getAttribute("account") == null) {
            ...
            int noOfRecords = pDao.GetNoOfRecordsPostInterestedByUser(account.getUserId(), textSearch, categoryId,
                    typeId, status, isPublic);
